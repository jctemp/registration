...
def load_losses(image_losses, flow_losses):
    image_losses = [str.split(s, ":") for s in str.split(str.lower(image_losses), "&")]
    flow_losses = [str.split(s, ":") for s in str.split(str.lower(flow_losses), "&")]
