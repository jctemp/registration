...
def conv1d(
    ...
    conv_fn = nnf.conv_transpose1d if transpose else nnf.conv1d
    result = conv_fn(
        result,
        weight,
        stride=stride,
...
def warp(x, disp, interp_mode="bilinear"):
    ...
    return nnf.grid_sample(x, warped_grid, mode=interp_mode, align_corners=False)
